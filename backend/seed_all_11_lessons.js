...
if (!atlasUri) {
    ...
    console.log('node seed_all_11_lessons.js "mongodb+srv://admin:parol@cluster.mongodb.net/lms-db"');
    process.exit(1);
}
...
const lessonsData = [
    {
        sequence: 1,
        title: "1-dars. Raqamli texnologiyalar va ularning rivojlanish bosqichlari",
        description: "Raqamli inqilob, axborot asrining kelib chiqishi, mikroprotsessorlar va birinchi kompyuterlardan bugungi kungacha bo'lgan rivojlanish.",
        ...
        textContent: `RAQAMLI TEXNOLOGIYALAR VA ULARNING RIVOJLANISH BOSQICHLARI

Insoniyat tarixi davomida ko'plab texnologik inqiloblarni boshidan kechirdi, ammo ularning hech biri raqamli inqilob kabi tezkor va keng ko'lamli bo'lmagan. Raqamli texnologiyalar hayotimizning har bir sohasiga kirib bordi.

Rivojlanish bosqichlari:
1. Birinchi bosqich (1940-1970 yillar): Ulkan elektron hisoblash mashinalari (EHM) va birinchi dasturlash tillarining yaratilishi.
2. Ikkinchi bosqich (1970-1990 yillar): Shaxsiy kompyuterlar (PC) davri va Internet tarmog'ining paydo bo'lishi.
3. Uchinchi bosqich (1990-2010 yillar): Mobil aloqa, smartfonlar va ijtimoiy tarmoqlarning global tarqalishi.
4. To'rtinchi bosqich (2010-yildan hozirgacha): Sun'iy intellekt, bulutli texnologiyalar, narsalar interneti (IoT) va blokcheyn.

Raqamli texnologiyalar iqtisodiyotni, ta'limni va ijtimoiy hayotni tubdan o'zgartirdi. Bugungi kunda raqamli savodxonlik har bir inson uchun suv va havodek zaruriy ko'nikmaga aylandi.`,
        transcript: "Ushbu kirish darsida biz raqamli texnologiyalar tarixi, kompyuterlarning evolyutsiyasi va bugungi to'rtinchi sanoat inqilobi haqida asosiy tushunchalarni ko'rib chiqamiz.",
        quiz: [
            {
                question: "Raqamli inqilob asosan qaysi asrda boshlandi?",
                options: ["XX asrning o'rtalarida", "XIX asr oxirida", "XXI asr boshida", "XVIII asr boshida"],
                correctAnswer: 0
            },
            {
                question: "Birinchi elektron hisoblash mashinasi (EHM) qanday nomlangan?",
                options: ["ENIAC", "Macintosh", "IBM PC", "Altair"],
                correctAnswer: 0
            },
            {
                question: "Raqamli texnologiyalarning 2-bosqichida qaysi muhim ixtiro ommalashdi?",
                options: ["Shaxsiy kompyuterlar va Internet", "Sun'iy intellekt", "Smartfonlar", "Bug' mashinasi"],
                correctAnswer: 0
            },
            {
                question: "To'rtinchi sanoat inqilobining asosiy harakatlantiruvchi kuchi nima?",
                options: ["AI, IoT, Bulutli texnologiyalar va Blokcheyn", "Faqat televideniye", "Mexanik to'quv dastgohlari", "Ko'mir va temir yo'llar"],
                correctAnswer: 0
            },
            {
                question: "Kompyuter tezligi va quvvatini belgilovchi eng asosiy mikrosxema nima?",
                options: ["Mikroprotsessor", "Kabel kanali", "Klaviatura", "Kuler (parrak)"],
                correctAnswer: 0
            },
            {
                question: "Internet dastlab qanday nomlangan?",
                options: ["ARPANET", "Intranet", "Ethernet", "WebNet"],
                correctAnswer: 0
            },
            {
                question: "Foydalanuvchilar o'rtasida raqamli muloqotni inqilob qilgan 3-bosqich qaysi?",
                options: ["Mobil telefonlar va ijtimoiy tarmoqlar davri", "Faqat telegram xabarlari", "Qog'oz xatlar davri", "EHM davri"],
                correctAnswer: 0
            },
            {
                question: "Raqamli savodxonlik nima?",
                options: ["Texnologiyadan to'g'ri, xavfsiz va samarali foydalanish ko'nikmasi", "Faqat matnni tez yozish", "Kompyuter yig'ish", "O'yin o'ynash"],
                correctAnswer: 0
            },
            {
                question: "Dunyodagi birinchi shaxsiy kompyuterlardan birini yaratgan kompaniya qaysi?",
                options: ["Apple / IBM", "Render", "Wolt", "Yandex"],
                correctAnswer: 0
            },
            {
                question: "Raqamli transformatsiya jarayoni nimani anglatadi?",
                options: ["An'anaviy xizmatlarni raqamli texnologiyalar orqali tubdan yangilash", "Faqat kompyuter sotib olish", "Eski saytlarni o'chirish", "Internet tezligini o'lchash"],
                correctAnswer: 0
            }
        ]
    },
    {
        sequence: 2,
        title: "2-dars. Bulutli hisoblash va uning afzalliklari",
        description: "Bulutli texnologiyalar arxitekturasi, SaaS, PaaS, IaaS modellari va korporativ ma'lumotlarni saqlash tizimlari.",
        category: "Raqamli texnologiyalar asoslari",
        thumbnailUrl: "https://picsum.photos/id/1042/800/600",
        ...
        documentUrl: "/uploads/documents/raqamli_texnologiyalar_asoslari.pdf",
        textContent: `BULUTLI HISOBLASH VA UNING AFZALLIKLARI

Bulutli hisoblash (Cloud Computing) - bu kompyuter resurslarini (xususan, ma'lumotlarni saqlash va hisoblash quvvatlarini) foydalanuvchining o'zida saqlamasdan, internet orqali masofaviy serverlarda saqlash va ishlatish tizimidir.

Asosiy xizmat ko'rsatish modellari:
1. Infrastructure as a Service (IaaS): Virtual serverlar va tarmoq infratuzilmasini ijaraga berish (masalan, AWS, Azure, Google Cloud).
2. Platform as a Service (PaaS): Dasturchilar uchun dasturiy ta'minot yaratish va ishga tushirish platformasi (masalan, Heroku, Render).
3. Software as a Service (SaaS): Tayyor dasturiy ta'minotni internet orqali ishlatish (masalan, Google Drive, Office 365).

Bulutli texnologiyalar xarajatlarni kamaytirish, ma'lumotlarni yo'qolib ketishidan himoya qilish va dunyoning istalgan chekkasidan resurslarga kirish imkonini taqdim etadi.`,
        transcript: "Ikkinchi darsimiz bulutli texnologiyalarga bag'ishlangan. Biz bulutli infratuzilma qanday ishlashini va uning zamonaviy bizneslar uchun qanday moliyaviy va texnik foydalari borligini tahlil qilamiz.",
        quiz: [
            {
                question: "Bulutli hisoblash (Cloud Computing) tushunchasining ma'nosi nima?",
                options: ["Resurslarni internet orqali masofaviy serverlarda saqlash va qayta ishlash", "Faqat ob-havoni prognoz qilish", "Kompyuterni simsiz ulash", "Faqat saytlarni bloklash"],
                correctAnswer: 0
            },
            {
                question: "Software as a Service (SaaS) modeliga qaysi biri misol bo'ladi?",
                options: ["Google Drive / Google Docs", "Virtual server", "Bo'sh ma'lumotlar bazasi", "Operatsion tizim diski"],
                correctAnswer: 0
            },
            {
                question: "Dasturchilarga kod yozish va deploy qilish muhitini beruvchi model nima deyiladi?",
                options: ["Platform as a Service (PaaS)", "Infrastructure as a Service (IaaS)", "Software as a Service (SaaS)", "Network as a Service"],
                correctAnswer: 0
            },
            {
                question: "Bulutli xizmatlarning eng katta moliyaviy afzalligi nima?",
                options: ["Server sotib olish uchun boshlang'ich kapital xarajatlarining yo'qligi (Pay-as-you-go)", "Faqat tekin bo'lishi", "Soliqlardan butunlay ozodligi", "Xodimlar maoshini kamaytirishi"],
                correctAnswer: 0
            },
            {
                question: "IaaS modeliga yaqqol misol keltiring:",
                options: ["AWS EC2 / Microsoft Azure VMs", "Dropbox", "Gmail", "Slack"],
                correctAnswer: 0
            },
            {
                question: "Bulutli ma'lumotlar xavfsizligini ta'minlashda kim mas'ul?",
                options: ["Bulut provayderi va mijoz birgalikda (Shared Responsibility Model)", "Faqat davlat", "Faqat foydalanuvchi", "Hech kim mas'ul emas"],
                correctAnswer: 0
            },
            {
                question: "Faqat bitta tashkilot foydalanishi uchun mo'ljallangan bulut qanday ataladi?",
                options: ["Xususiy bulut (Private Cloud)", "Ommaviy bulut (Public Cloud)", "Gibrid bulut (Hybrid Cloud)", "Uchinchi tomon buluti"],
                correctAnswer: 0
            },
            {
                question: "Ommaviy va xususiy bulutlarning birgalikdagi integratsiyasi nima deyiladi?",
                options: ["Gibrid bulut (Hybrid Cloud)", "Yopiq tarmoq", "Global bulut", "Bulutli server"],
                correctAnswer: 0
            },
            {
                question: "Ma'lumotlar yo'qolishining oldini olish uchun bulutda qanday amal bajariladi?",
                options: ["Avtomatik zaxira nusxalash (Auto backup / replication)", "Matnlarni o'chirish", "Parollarni bekor qilish", "Fayllarni siqish"],
                correctAnswer: 0
            },
            {
                question: "Bulutli saqlash tizimlarining an'anaviy qattiq disklardan (HDD/SSD) ustunligi nima?",
                options: ["Dunyoning istalgan joyidan internet orqali kirish imkoniyati", "Faqat arzonligi", "Kattaroq jismoniy o'lchami", "Simli ulanishi"],
                correctAnswer: 0
            }
        ]
    },
...
Proof of Work (PoW) konsensus algoritmi tranzaksiyalarni tasdiqlash uchun ulkan kompyuter quvvatini talab qiladi. Bu esa dunyo bo'ylab elektr energiyasi iste'molini keskin oshiradi. Masalan, Bitcoin tarmog'ining yillik energiya sarfi ko'plab o'rta o'lchamdagi davlatlar yillik sarfidan oshib ketadi. Geosiyosiy nuqtai nazardan, kriptovalyutalar milliy valyutalarning monopoliyasiga tahdid soladi va sanksiyalarni chetlab o'tish vositasi sifatida ham qo'llanilishi mumkin.`,
        ...
        quiz: [
            ...
            },
            {
                ...
                options: ["O'z-o'zidan baja riladigan raqamli shartnoma kodi", "Aqlli telefonlar ro'yxati", "Foydalanuvchilar kelishuvi hujjati", "Aloqa kanali"],
                correctAnswer: 0
            },
            {
...
Gig ishchilari qonun bo'yicha 'mustaqil pudratchi' (independent contractor) hisoblanadilar, 'rasmiy xodim' emas. Bu esa ularni mehnat ta'tili, kasallik varaqasi, tibbiy sug'urta va pensiya ta'minotidan mahrum qiladi. Platforma algoritmlari esa ishchilarni reyting tizimi va jarimalar orqali qattiq nazorat qiladi, bu esa algoritmik boshqaruv ostidagi bosimni kuchaytiradi. Shahar bo'ylab minglab kuryerlarning harakati esa tirbandliklar va qadoqlash chiqindilarining ko'payishiga ham sabab bo'ladi.`,
        ...
        quiz: [
            ...
            },
            {
                ...
                options: ["Ular rasmiy xodim emas, 'mustaqil pudratchi' hisoblanadi", "Ko'proq maosh oladilar", "Faqat davlat idoralarida ishlaydilar", "Ularga soliq solinmaydi"],
                correctAnswer: 0
            },
            {
        ...
        quiz: [
            {
                ...
                options: ["Internet tarmog'iga ulangan va o'zaro ma'lumot almashuvchi jismoniy qurilmalar tarmog'i", "Faqat shaxsiy kompyuterlar to'plami", "Simli telephone tizimi", "Internet provayderlar ro'yxati"],
                correctAnswer: 0
            },
            {
...
async function seedLessons() {
    try {
        ...
        if (!superAdmin) {
            console.error("\x1b[31mXATO: Bosh admin ('super-admin') foydalanuvchisi topilmadi!\x1b[0m");
            process.exit(1);
        }
        console.log(`\x1b[32m✔ Super Admin topildi: ${superAdmin.name} (${superAdmin._id})\x1b[0m\n`);

        console.log("\x1b[36m=== 2-QADAM: Mavjud barcha darslarni tozalash ===\x1b[0m");
        await Lesson.deleteMany({ instructor: superAdmin._id });
        await OfficialLesson.deleteMany({});
        await OfficialCourse.deleteMany({});
        console.log("\x1b[32m✔ Barcha darslar va rasmiy kurslar tozalandi.\x1b[0m\n");

        console.log("\x1b[36m=== 3-QADAM: Yangi 11 ta mukammal darsni (M1-M11) Lesson kolleksiyasiga saqlash ===\x1b[0m");
        const savedLessons = [];
        for (const data of lessonsData) {
            ...
            console.log(`+ [Lesson] Yaratildi: "${saved.title}"`);
        }

        console.log("\n\x1b[36m=== 4-QADAM: Rasmiy Kurs (OfficialCourse) va Rasmiy Darslarni (OfficialLesson) to'g'ridan-to'g'ri yaratish ===\x1b[0m");
        const defaultCourse = new OfficialCourse({
            title: 'Premium Bilimlar Akademiyasi',
            description: 'Platformaning barcha asosiy multimodal darslari va resurslari.',
            thumbnail: savedLessons[0].thumbnailUrl,
            sequence: -1
        });

        const officialLessonIds = [];
        for (const lesson of savedLessons) {
            const officialLesson = new OfficialLesson({
                title: lesson.title,
            ...
            const savedOL = await officialLesson.save();
            officialLessonIds.push(savedOL._id);
            console.log(`+ [OfficialLesson] Ko'chirildi: "${savedOL.title}"`);
        }

        defaultCourse.lessons = officialLessonIds;
        await defaultCourse.save();
        console.log(`\n\x1b[32m✔ Premium Bilimlar Akademiyasi kursi ${officialLessonIds.length} ta dars bilan muvaffaqiyatli yaratildi!\x1b[0m`);

        console.log("\n\x1b[32m✔ TABRIKLAYMAN! BARCHA 11 TA DARSLAR BAZADA MUKAMMAL, BITTA-BITTADAN VA HECH QANDAY TAKRORLANISHLARSIZ QAYTA TIKLANDI!\x1b[0m\n");
